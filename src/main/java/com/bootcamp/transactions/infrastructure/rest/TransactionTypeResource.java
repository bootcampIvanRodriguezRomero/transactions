...
public class TransactionTypeResource {
    ...
    @PostMapping
    public Mono<TransactionTypeDto> createTransactionType(@Valid @RequestBody TransactionTypePostDto transactionTypePostDto) {
        TransactionTypeDao transactionTypeDao = fromTransactionTypePostDtoToTransactionTypeDao(transactionTypePostDto);
        return transactionTypeRepository.save(transactionTypeDao)
                .map(this::fromTransactionTypeDaoToTransactionTypeDto);
    }

    @PutMapping("/{id}")
    public Mono<TransactionTypeDto> updateTransactionType(@PathVariable String id, @Valid @RequestBody TransactionTypeDto transactionTypeDto) {
        return transactionTypeRepository.findById(id)
    ...
    private TransactionTypeDto fromTransactionTypeDaoToTransactionTypeDto(TransactionTypeDao transactionTypeDao) {
    ...
    private TransactionTypeDao fromTransactionTypePostDtoToTransactionTypeDao(TransactionTypePostDto transactionTypePostDto) {
